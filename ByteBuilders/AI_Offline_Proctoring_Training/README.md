...
*(Add a license here — MIT is a common default for student/portfolio
projects if you want others to be able to freely use and modify it.
Nothing is enforceable without one on GitHub; an empty repo with no
`LICENSE` file defaults to "all rights reserved.")*
